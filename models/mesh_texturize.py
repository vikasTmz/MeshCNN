...
class TexturizeModel:
    ...
    def backward(self, out):
        ...
        gt_gemm = self.labels[self.mesh[0].tvloss_edges[:,0]]#torch.stack((self.labels[self.mesh[0].tvloss_edges[:,0]], self.labels[self.mesh[0].tvloss_edges[:,1]]), axis=1)
        out_gemm = out[self.mesh[0].tvloss_edges[:,0]]#torch.stack((out[self.mesh[0].tvloss_edges[:,0]], out[self.mesh[0].tvloss_edges[:,1]]), axis=1)
