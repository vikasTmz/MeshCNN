...
def run_test(epoch=-1):
    ...
    for j, data in enumerate(dataset):
        ...
        for i, edges in enumerate(mesh[0].org_edges):
            gt_vcolor[edges[0]] = update_vertex_color(gt_vcolor[edges[0]], [gt[i],0,0])
            gt_vcolor[edges[1]] = update_vertex_color(gt_vcolor[edges[1]], [gt[i],0,0])

            out_vcolor[edges[0]] = update_vertex_color(out_vcolor[edges[0]], [out[i],0,0])
            out_vcolor[edges[1]] = update_vertex_color(out_vcolor[edges[1]], [out[i],0,0])        
