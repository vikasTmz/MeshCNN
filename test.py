...
def run_test(epoch=-1):
    ...
    for j, data in enumerate(dataset):
        ...
        for i, edges in enumerate(mesh[0].org_edges):
            gt_vcolor[edges[0]] = update_vertex_color(gt_vcolor[edges[0]], [gt_g[i]])
            gt_vcolor[edges[1]] = update_vertex_color(gt_vcolor[edges[1]], [gt_g[i]])

            out_vcolor[edges[0]] = update_vertex_color(out_vcolor[edges[0]], [out_g[i]])
            out_vcolor[edges[1]] = update_vertex_color(out_vcolor[edges[1]], [ out_g[i]])        
